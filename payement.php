				...
				<div class="row">
					...
					<div class="col-lg-6 col-md-6">
						<div class="payement__order">
							...
							<ul>
								<li>Vegetable’s Package <span>75.99 FCFA</span></li>
								<li>Fresh Vegetable <span>151.99 FCFA</span></li>
								<li>Organic Bananas <span>53.99 FCFA</span></li>
							</ul>
							<div class="payement__order__total">Total <span>750.99 FCFA</span></div>
