...
?>
                        ...
                        <div class="sidebar__item">
                            ...
                            <div class="price-range-wrap">
                                <div class="price-range ui-slider ui-corner-all ui-slider-horizontal ui-widget ui-widget-content"
                                     data-min="<?= $getMinProducts->fetch()[0] ?>"
                                     data-max="<?= $getMaxProducts->fetch()[0] ?>">
                                    ...
                                    <div class="col-lg-4">
                                        <div class="product__discount__item">
                                            ...
                                            <div class="product__discount__item__pic set-bg"
                                                ...
                                                <div class="product__discount__percent">-<?= $solde['pourcentage']; ?>
                                                    %
                                                </div>
                                            ...
                                            <div class="product__discount__item__text">
                                                ...
                                                <h5><a href="./produit-details.php"><?= $solde['nom_produit']; ?></a>
                                                </h5>
                                                <div class="product__item__price"><?= $solde['prix_produit'] * (1 - $solde['pourcentage'] / 100); ?>
                                                    FCFA <span><?= $solde['prix_produit']; ?> FCFA</span></div>
                                            </div>
                                        </div>
                                    </div>
                                <?php } ?>
                    ...
                    <div class="row">
                        <?php while ($product = $getAllProducts->fetch()) { ?>
                            <div class="col-lg-4 col-md-6 col-sm-6">
                                <div class="product__item produit_s">
                                    <span hidden class="produit_id"><?= $product['id']?></span>
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <span hidden id="id_select"></span>
                        Voulez-vous ajouter cet article à votre panier ?
                    </div>
                    <div class="modal-footer">
                        <button type="button" class="btn btn-secondary" data-dismiss="modal">Non</button>
                        <button id="yes_click" type="button" class="btn btn-primary">Oui</button>
                    </div>
                </div>
            </div>
        </div>
    ...
    <script>
        $(".produit_s").click(function () {

            $("#id_select").text($(this).find(".produit_id").text())
        ...
        $("#yes_click").click(function () {
            ...
            ajouterAuPanier($("#id_select").text())
        })
        ...
        function ajouterAuPanier(id) {
            ...
            $.ajax({
                method: "POST",
                url: window.location.origin + "/commande/panier.php?action=1",
                data: {id: id}
            })
                .done(function (data) {

                   $("#total_panier").text(data.prix_pr);
                    $("#nb_produit").text(data.total);
                });
        }
